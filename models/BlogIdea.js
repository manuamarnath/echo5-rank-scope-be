...
const BlogIdeaSchema = new mongoose.Schema({
  ...
  primaryKeywordId: { type: mongoose.Schema.Types.ObjectId, ref: 'Keyword', default: null },
  secondaryKeywordIds: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Keyword' }],
  suggestedSlug: { type: String, default: null },
  outline: { type: String, default: null },
  targetPageId: { type: mongoose.Schema.Types.ObjectId, ref: 'Page', default: null },
